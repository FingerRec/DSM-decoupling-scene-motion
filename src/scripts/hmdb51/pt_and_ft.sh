#!/usr/bin/env bash
python main.py --gpus 0 --method pt_and_ft --pt_method dsm \
--pt_batch_size 3 --pt_workers 3  --arch i3d --pt_spatial_size 224 --pt_stride 4 --pt_data_length 32 \
--pt_nce_k 3569 --pt_softmax \
--pt_moco --pt_epochs 100 --pt_save_freq 4 --pt_print_freq 100 --pt_dataset ucf101 \
...
--ft_lr 0.001 --ft_lr_steps 30 50 65 80 90 95 --ft_epochs 100 --ft_batch_size 4 \
